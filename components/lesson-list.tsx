  ...
  return (
    <section className="relative space-y-6">
      <div className={`flex items-center justify-between`}>
        <div>
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Course Lessons</h2>
        ...
        {isOwner && (
          <button
            className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg shadow transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          >
            <div className="flex flex-col items-center gap-2 text-gray-700 dark:text-gray-300">
              ...
              <p className="text-sm font-medium text-center">
                Purchase or enroll to access lessons
              </p>
            </div>
          </motion.div>
        )}
      ...
      >
        {course?.lessons?.map((lesson) => (
          <li
            ...
            className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row items-start gap-4 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-between w-full">
              ...
              <span className="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1">
                <Clock size={14} /> {lesson.duration || '0m'}
              </span>
            </div>

            {isOwner && (
              <div className="flex gap-3 self-end md:self-center mt-2 md:mt-0">
                <button
                  title="Edit Lesson"
